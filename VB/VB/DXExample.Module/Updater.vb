...
Namespace DXExample.Module
	Public Class Updater
		...
		Public Overrides Sub UpdateDatabaseAfterUpdateSchema()
			...
			Dim user1 As CustomUser = Session.FindObject(Of CustomUser)(New BinaryOperator("UserName", "Admin"))
			If user1 Is Nothing Then
				...
				user1.SetPassword("")
			End If
			Dim user2 As CustomUser = Session.FindObject(Of CustomUser)(New BinaryOperator("UserName", "User"))
